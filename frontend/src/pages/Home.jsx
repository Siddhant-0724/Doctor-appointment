        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[570px]'>
              ...
              <p className='text_para'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequuntur tenetur eius velit aliquam quasi nesciunt hic non nisi praesentium aliquid officiis, esse maiores molestiae facilis ad autem a quis blanditiis?</p>
    ...
    <section>
      <div className="container">
        <div className='lg:w-[470px] mx-auto'>
          ...
          <p className='text_para text-center'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit eligendi numquam i</p>
        </div>
