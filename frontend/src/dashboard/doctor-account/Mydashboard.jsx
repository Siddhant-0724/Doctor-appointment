...
import startIon from '../../assets/images/Star.png'
import Doctorabout from '../../pages/Doctor/Doctorabout'
import Profile from './Profile'
import Appointment from './Appointment'
const Mydashboard = () => {
  const { data, loading, error } = getUserProfile(`${BASE_URL}/doctors/profile/me`);
              ...
              {data.isApproved === "pending" && (
                <div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                  ...
                  <div className="ml-3 text-sm font-medium">
                    To get approval please complete your profile. We&apos;ill review manually and approve within 3days.
                  </div>
                </div>
              )}
              <div className='mt-8'>
                {tab === 'overview' &&
                  <div>
                    <div className='flex items-center gap-4 mb-20'>
                      <figure className='max-w-[200px] max-h-[200px]'><img src={data?.photo} className="w-full" /></figure>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-[6px]">
                          <span className='flex items-center gap-[6px] text-headingColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold'><img src={startIon} alt="" />{data.averageRating}</span>
